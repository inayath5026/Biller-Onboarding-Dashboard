    ...
    const fetchForm = async () => {
      try {
        ...
        if (res.data) {
          ...
          // Map API response to form state keys
          setFormData({
            legalName: apiData.legalName || "",
            entityType: apiData.businessType || "",
            physicalAddress: apiData.physicalAddress || "",
            dbaName: apiData.merchantDBA || "",
            tin: apiData.tin || "",
            officePhone: apiData.officePhone || "",
            customerServicePhone: apiData.customerServicePhone || "",
            businessStartDate: apiData.businessStartDate
              ? apiData.businessStartDate.split("T")[0]
              : "",
            fiscalYearEnd: apiData.fiscalYearEnd
              ? apiData.fiscalYearEnd.split("T")[0]
              : "",
            websiteUrl: apiData.websiteUrl || "",
          });

          console.log("Fetched form data:", apiData);
        }
      } catch (err) {
